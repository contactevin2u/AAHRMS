...
export const payrollV2Api = {
  ...
  refreshClaims: (runId) => api.post(`/payroll/runs/${runId}/refresh-claims`),
  recalculate: (runId, options) => api.post(`/payroll/runs/${runId}/recalculate`, options),
...
export const essApi = {
  ...
  updateClaimAmount: (id, amount) => api.put(`/ess/claims/${id}/amount`, { amount }, essApiConfig),
